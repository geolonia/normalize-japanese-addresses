...
test('大阪府堺市堺区向陵西町2丁1-26 ハイツ三国ヶ丘二番館1階二号室', async () => {
  const res = await normalize('大阪府堺市堺区向陵西町2丁1-26 ハイツ三国ヶ丘二番館1階二号室')
  expect(res).toStrictEqual({"pref": "大阪府", "city": "堺市堺区", "town": "向陵西町2丁", "addr": "1-26", "building": "ハイツ三国ヶ丘二番館1階二号室"})
})

test('大阪府堺市堺区向陵西町2丁1-26 ハイツ三国ヶ丘十号室', async () => {
  const res = await normalize('大阪府堺市堺区向陵西町2丁1-26 ハイツ三国ヶ丘十号室')
  expect(res).toStrictEqual({"pref": "大阪府", "city": "堺市堺区", "town": "向陵西町2丁", "addr": "1-26", "building": "ハイツ三国ヶ丘十号室"})
})

test('大阪府堺市堺区向陵西町2丁1-26 ハイツ向陵西町二番館1階二号室', async () => {
  const res = await normalize('大阪府堺市堺区向陵西町2丁1-26 ハイツ向陵西町二番館1階二号室')
  expect(res).toStrictEqual({"pref": "大阪府", "city": "堺市堺区", "town": "向陵西町2丁", "addr": "1-26", "building": "ハイツ向陵西町二番館1階二号室"})
})
