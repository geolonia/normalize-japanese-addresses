...
test('東京都品川区西五反田２丁目32-7 第3五反田ビル十階百二号室', async () => {
  const res = await normalize('東京都品川区西五反田２丁目32-7 第3五反田ビル十階百二号室')
  expect(res).toStrictEqual({"pref": "東京都", "city": "品川区", "town": "西五反田２丁目", "addr": "32-7", "building": "第3五反田ビル十階百二号室"})
})
